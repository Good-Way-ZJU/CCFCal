...
@interface CCFCalWindowFrameView : NSView
@property (nonatomic, assign) CGFloat arrowMidX;
@end

#pragma mark -
#pragma mark CCFCalWindow

// =========================================================================
// CCFCalWindow
// =========================================================================

@implementation CCFCalWindow
{
...
- (void)setContentView:(NSView *)aView
{
    ...
    CCFCalWindowFrameView *frameView = [super contentView];
    if (!frameView) {
        frameView = [[CCFCalWindowFrameView alloc] initWithFrame:NSZeroRect];
...
#pragma mark -
#pragma mark CCFCalWindowFrameView

// =========================================================================
// CCFCalWindowFrameView
// =========================================================================

@implementation CCFCalWindowFrameView
...
- (void)drawRect:(NSRect)dirtyRect
{
    ...
    // radius). This accounts for the edge-case where CCFCal is
