...
{
    for (MoCalCell *c in _dateGrid.cells) {
        NSColor *ddlColor = [self.delegate ddlHighlightColorForDate:c.date];
        c.hasDDLHighlight = (ddlColor != nil);
        c.ddlHighlightColor = ddlColor;
        c.dotColors = (self.showEventDots && ddlColor == nil)
